...
description: "3G(third generation)— технологии мобильной связи 3-го поколения; набор услуг, который объединяет как высокоскоростной мобильный доступ с услугами сети"
type: article
...
images_count: 0
tags: [икс, словарь, термины, сети, протоколы]
---

# Словарь терминов

Словарь терминов, используемых в документации Интернет Контроль Сервер.
