...
В ИКС поддерживаются два вида [каналов](provaydery-telefonii-2.md) — [SIP](../../o-dokumentacii/slovar-terminov-3.md) и [IAX](../../o-dokumentacii/slovar-terminov-3.md), а также два вида аналогичных [туннелей](https://doc.a-real.ru/index.php?article=248), предназначенных для соединения телефонии двух ИКС.
