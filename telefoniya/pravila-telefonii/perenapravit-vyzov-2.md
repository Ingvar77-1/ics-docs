...
5. На вкладке **«Условия»** задайте условия срабатывания правила по аналогии с [правилом](https://doc.a-real.ru/index.php?article=250) «Повесить трубку».
...
**Источник:** [Документация ИКС — Перенаправить вызов](https://doc.a-real.ru/index.php?article=252)
