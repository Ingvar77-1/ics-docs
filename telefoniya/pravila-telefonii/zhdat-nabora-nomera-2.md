...
5. Если требуется, укажите [время действия](https://doc.a-real.ru/index.php?article=196#time) правила. Оно устанавливается следующим образом: время установленной мелодии ожидания + время, указанное в поле «Ждать набора номера». Если за отведенное время пользователь не введет номер, то обработка звонка продолжится по набору правил, но **назначение звонка станет пустым**.
...
**Источник:** [Документация ИКС — Ждать набора номера](https://doc.a-real.ru/index.php?article=251)
