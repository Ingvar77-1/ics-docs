...
# Настройки DNS-записей для почтового сервера
...
**Источник:** [Документация ИКС — Настройки DNS-записей для почтового сервера](https://doc.a-real.ru/index.php?article=233)
