...
При необходимости часовой пояс можно будет изменить в [модуле](/index.php?article=112) **«Время и дата»**. После изменения часового пояса перезагрузите сервер, иначе не все модули смогут логировать свои события по установленной временной зоне.
