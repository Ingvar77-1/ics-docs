...
2. Полученный файл можно импортировать как сертификат на ИКС через веб-интерфейс в разделе [сертификаты](https://doc.a-real.ru/index.php?article=78).
...
**Источник:** [Документация ИКС — Установка доверенного SSL-сертификата на сервер](https://doc.a-real.ru/index.php?article=276)
