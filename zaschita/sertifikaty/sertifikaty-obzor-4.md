...
Модуль **«Сертификаты»** предназначен для управления сертификатами, которые используются в установлении защищенных [SSL](https://doc.a-real.ru/index.php?article=24#ssl)/[TLS](https://doc.a-real.ru/index.php?article=24#tls)-соединений типа клиент-сервер.
...
При первой [установке ИКС](https://doc.a-real.ru/index.php?article=269) автоматически создаются конечные сертификаты [для веб-интерфейса](https://doc.a-real.ru/index.php?category=16), [телефонии](https://doc.a-real.ru/index.php?article=268) и [почты](https://doc.a-real.ru/index.php?article=266).

Для открытия модуля перейдите в меню **Защита > Сертификаты**.

![Иллюстрация](../images/article_78/certificates1-2.png)

Список сертификатов представлен в виде иерархического древа. В таблице отображаются следующие сведения: тип ключа родительского сертификата, дата начала и окончания действия, имя хоста (или [IP-адрес](https://doc.a-real.ru/index.php?article=24#ip-address)), который представляет данный сертификат, состояние.
