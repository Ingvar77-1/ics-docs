...
Сервис Garnet расширяет список возможных [категорий трафика](../../polzovateli-i-statistika/kategorii-trafika/kategorii-trafika-obzor-2.md), которые могут быть использованы в [запрещающих](../../polzovateli-i-statistika/polzovatelskie-pravila-dostupa/zapreschayuschee-pravilo-proksi-2.md), [разрешающих](../../polzovateli-i-statistika/polzovatelskie-pravila-dostupa/razreshayuschee-pravilo-proksi.md) правилах прокси или [исключениях прокси](../../polzovateli-i-statistika/polzovatelskie-pravila-dostupa/isklyuchenie-proksi-3.md) для пользователей и групп пользователей.
...
Служба «Веб-фильтр Garnet» отвечает за работоспособность предустановленного веб-фильтра Garnet, который определяет, к какой категории принадлежит открываемый веб-сайт (если установлен соответствующий флаг в настройках [прокси-сервера](../../set/proksi/proksi-obzor.md)).

> ⚠ Внимание! По умолчанию служба находится в состоянии «не настроен». Чтобы активировать ее, установите в настройках [прокси-сервера](../../set/proksi/proksi-obzor.md) флаг **«Использовать Garnet»**.
...
Флаг **«Использовать в прокси»** соответствует аналогичному флагу в настройках [прокси](../../set/proksi/proksi-obzor.md). Данный флаг включает Веб-фильтр Garnet для фильтрации трафика, проходящего через прокси-сервер. Если флаг установлен, то можно определить **размер кеша** прокси, который будет использоваться для обработки данных, а также **время ожидания ответа** от облачного сервиса.
...
На вкладке настроек также доступен функционал проверки конкретных [URL](../../o-dokumentacii/slovar-terminov-3.md)-адресов. После ввода необходимого URL и нажатия кнопки **«Проверить»** будет выведен список категорий сервиса Garnet, к которым относится введенный URL, либо категория не будет определена, если проверяемый сайт или сам сервис не доступны.
