...
description: "Модуль Антиспам Касперского для защиты от спама. Проверяет входящие и исходящие почтовые сообщения и сортирует их в соответствии с установленными параметрами."
type: article
section: "zaschita"
...
images_count: 7
tags: [икс, антиспам, почта, касперский, защита]
---
