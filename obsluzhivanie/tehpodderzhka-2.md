...
- за [межсетевым экраном](https://doc.a-real.ru/index.php?article=24/#firewall), который запрещает входящие соединения;
- в серой сети за [NAT](https://doc.a-real.ru/index.php?article=24/#nat)-устройством (модем, роутер).
...
**Источник:** [Документация ИКС — Техподдержка](https://doc.a-real.ru/index.php?article=116)
