...
[Порядок обновления](https://doc.a-real.ru/index.php?article=432) узлов кластера имеет свои особенности.
...
3. На Основном в [меню](https://doc.a-real.ru/index.php?article=255) **Файловый сервер > Хранилище файлов** создать папку `/primary/sales`.
...
**Источник:** [Документация ИКС — Кластер](https://doc.a-real.ru/index.php?article=423)
