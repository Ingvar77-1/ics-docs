...
5. На Основном в [меню](../../faylovyy-server/hranilische-faylov/ftpresurs.md) **Добавление FTP-ресурса** поставить галки разрешений для пользователя `Test`, нажать **«Добавить»**.
