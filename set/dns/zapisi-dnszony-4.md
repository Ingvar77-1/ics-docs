...
description: "DNS-записи домена — записи в системе доменных имен о соответствии имени и служебной информации о сервере. В ИКС поддерживаются NS, A, MX, CNAME, SRV, TXT и PTR-записи."
type: article
section: "set/dns"
...
images_count: 8
tags: [икс, dns, записи, сети, настройка]
---

# Записи DNS-зоны

DNS-записи домена представляют собой записи в системе доменных имен о соответствии имени и служебной информации о сервере, на которое это имя должно указывать.

---

DNS-записи домена представляют собой записи в системе доменных имен о соответствии имени и служебной информации о сервере, на которое это имя должно указывать. Каждая такая запись необходима для работы определенной службы. Например, в DNS-запись типа MX вносятся данные для корректной работы электронной почты на домене.

Добавить запись DNS-зоны можно в меню **Сеть > DNS > Зоны**. Нажмите **«Добавить > Запись»** и выберите нужный объект.

![Настройка DNS-зоны](../../../images/article_229/49995-dns_zone2-12.4.png)
...
![Настройка NS-записи](../../../images/article_229/record_ns.png)

Нажмите **«Добавить»** — созданная запись появится в списке.

## A-запись

Запись A (address record), или запись адреса, связывает имя хоста с IP-адресом.
...
![Настройка A-записи](../../../images/article_229/record_a.png)
...
![Настройка MX-записи](../../../images/article_229/record_mx.png)
...
![Настройка CNAME-записи](../../../images/article_229/record_cname.png)
...
- протокол — протокол, по которому предоставляется сервис (TCP, UDP);
...
![Настройка SRV-записи](../../../images/article_229/record_srv.png)
...
![Настройка TXT-записи](../../../images/article_229/record_txt.png)
...
![Настройка PTR-записи](../../../images/article_229/record_ptr.png)
