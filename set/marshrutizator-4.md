...
В сервисе реализована поддержка [OSPF](../o-dokumentacii/slovar-terminov-3.md) (Open Shortest Path First) — протокола динамической маршрутизации семейства link-state (основан на отслеживании состояния канала) и [BGP](../o-dokumentacii/slovar-terminov-3.md) (border gateway protocol) – протокола маршрутизации внешнего шлюза.
...
**«Статические маршруты»** (static) — маршруты, расположенные в [меню](marshruty/dobavit-marshrut-2.md) **Сеть > Маршруты > Статические маршруты**.
