...
Модуль **«VPN»** предназначен для контроля пользователей, которые подключаются к ИКС по технологии [VPN](https://doc.a-real.ru/index.php?article=24#vpn) . Для открытия данного модуля перейдите в меню **Сеть > VPN** .
...
На данной вкладке отображаются следующие сведения о Службе [PPP](https://doc.a-real.ru/index.php?article=24#ppp) -соединений, [OpenVPN](https://doc.a-real.ru/index.php?article=24#openvpn) , [SSTP](https://doc.a-real.ru/index.php?article=24#sstp) и [Wireguard](https://doc.a-real.ru/index.php?article=392) .
...
Если флаг установлен, необходимо: 1) настроить [Kerberos](https://doc.a-real.ru/index.php?article=190#tab1) ; 2) доменный пользователь должен подключаться по [L2TP](https://doc.a-real.ru/index.php?article=24#l2tp) с IPSec, в настройках подключения у пользователя должна быть выбрана проверка подлинности PAP (протоколы CHAP и MS-CHAPv2 рекомендуется отключить);
- **«Автоматически создавать разрешающее правило»** — предоставляет доступ к VPN-серверу из внешней сети. По ссылке на экране можно перейти к [правилам](https://doc.a-real.ru/index.php?article=27#tab3) межсетевого экрана;
- **«Автоматически создавать разрешающее правило OpenVPN»** — предоставляет доступ к OpenVPN-сетям. По ссылке на экране можно перейти к [правилам](https://doc.a-real.ru/index.php?article=27#tab3) межсетевого экрана.
...
- в настройках [VPN-сети](https://doc.a-real.ru/index.php?article=197) , [OpenVPN-сети](https://doc.a-real.ru/index.php?article=198) и (или) [SSTP-сети](https://doc.a-real.ru/index.php?article=311) установлен флаг **«Использовать двухфакторную аутентификацию»** ;
- запущен [Telegram-бот](https://doc.a-real.ru/index.php?article=413) или [TOTP](https://doc.a-real.ru/index.php?article=113) . 
...
**Источник:** [Документация ИКС — VPN](https://doc.a-real.ru/index.php?article=63)
