...
Для запуска утилиты введите доменное имя или [IP-адрес](https://doc.a-real.ru/index.php?article=24#ip-address) и укажите количество пакетов.
...
Утилита «Опрос DNS» (dig) позволяет посылать различные запросы к [DNS](https://doc.a-real.ru/index.php?article=24#dns)-серверам и определять ошибки в их конфигурации.

Для запуска утилиты введите домен и выберите [тип записи](https://doc.a-real.ru/index.php?article=229). Также можно указать конкретный DNS-сервер для опроса.
...
Утилита дамп (tcpdump) отображает заголовки пакетов, проходящих через выбранный сетевой интерфейс. Позволяет диагностировать проблемы, связанные с настройкой [межсетевого экрана](https://doc.a-real.ru/index.php?article=27), маршрутизацией и работой сетевых сервисов.
...
Удаление dump-файлов можно организовать по времени или по объему в [модуле](https://doc.a-real.ru/index.php?article=107) **«Система»**.
