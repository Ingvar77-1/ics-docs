...
Маршруты создаются по аналогии с [пользовательскими маршрутами](https://doc.a-real.ru/index.php?article=164), но могут иметь дополнительные опции: источник, порт источника, интерфейс, флаг «Использовать [NAT](https://doc.a-real.ru/index.php?article=24#nat)».
...
**Источник:** [Документация ИКС — Добавить маршрут](https://doc.a-real.ru/index.php?article=58)
