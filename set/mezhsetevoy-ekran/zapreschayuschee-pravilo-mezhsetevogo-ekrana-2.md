...
4. При необходимости установите флаг **«Отправить ICMP Unreachable»**. Тогда при попытке одной стороны выполнить команду [ping](https://doc.a-real.ru/index.php?article=57#ping) другой стороны отправится данное сообщение и [ICMP](https://doc.a-real.ru/index.php?article=24/#icmp)-пакет будет заблокирован.
...
Чтобы создать исключение для запрещающего правила, используйте [разрешающее правило](https://doc.a-real.ru/index.php?article=206).

---

**Источник:** [Документация ИКС — Запрещающее правило межсетевого экрана](https://doc.a-real.ru/index.php?article=207)
