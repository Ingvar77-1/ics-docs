...
- [разрешающие](https://doc.a-real.ru/index.php?article=206) — разрешают доступ;
- [запрещающие](https://doc.a-real.ru/index.php?article=207) — запрещают, ограничивают доступ;
- [приоритеты](https://doc.a-real.ru/index.php?article=208) — определяют, какой трафик будет обрабатываться в первую очередь (например, телефония), а какой — в последнюю (например, e-mail);
...
6. Выберите **время действия**. Это один из стандартных [элементов](https://doc.a-real.ru/index.php?article=196#time) веб-интерфейса ИКС.
...
> ⚠ Внимание! Из блокировок по геолокации автоматически исключаются следующие объекты, созданные на ИКС: [локальная сеть](https://doc.a-real.ru/index.php?article=200), [VPN-сеть](https://doc.a-real.ru/index.php?article=197), [SSTP-сеть](https://doc.a-real.ru/index.php?article=311), [Wireguard-сеть](https://doc.a-real.ru/index.php?article=392), [OpenVPN-сеть](https://doc.a-real.ru/index.php?article=198), [внутренняя сеть](https://doc.a-real.ru/index.php?article=199). Также в исключения попадают сети из [констант](https://doc.a-real.ru/index.php?article=119), прописанные в net.nat_networks.
...
**Источник:** [Документация ИКС — Межсетевой экран](https://doc.a-real.ru/index.php?article=27)
