...
Добавить [SSTP](../../o-dokumentacii/slovar-terminov-3.md)-сеть можно в меню **Сеть > Провайдеры и сети**. Для этого выполните следующие действия:
...
5. При необходимости введите **IP-адрес DNS-сервера** и (или) **IP-адрес альтернативного DNS-сервера**. Они будут выданы подключенным к данной сети хостам по [DHCP](../../o-dokumentacii/slovar-terminov-3.md).
...
7. Для того чтобы **использовать [двухфакторную аутентификацию](../vpn/vpn-obzor-2.md)**, установите соответствующий флаг.
...
9. Если требуется, установите **флаги**:
   ...
   - «Разрешить управление ИКС через [SSH](../../o-dokumentacii/slovar-terminov-3.md)».

10. Сертификат и порты для работы SSTP-сервера можно изменить в настройках [модуля](../vpn/vpn-obzor-2.md) **«VPN»**.
...
15. В [модуле](../vpn/vpn-obzor-2.md) **«VPN»** укажите, какие пользователи могут подключаться к ИКС по VPN.
...
> ⚠ Для подключения к SSTP-сети необходимо запустить службу [DHCP](../dhcp-2.md).
