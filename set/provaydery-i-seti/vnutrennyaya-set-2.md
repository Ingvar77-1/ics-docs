...
4. При установке флага **«Разрешить DHCP в этой сети»** данный интерфейс назначается раздающим адреса локальным компьютерам из задаваемого диапазона, по протоколу [DHCP](https://doc.a-real.ru/index.php?article=61).
...
**Источник:** [Документация ИКС — Внутренняя сеть](https://doc.a-real.ru/index.php?article=199)
