...
Рассмотрим основные принципы того, как правильно указывать адреса в [категориях трафика](sozdat-kategoriyu-trafika.md).
...
Требуется заблокировать ВСЕ страницы ресурса mail.ru. Создадим [запрещающее правило прокси](../polzovatelskie-pravila-dostupa/zapreschayuschee-pravilo-proksi-2.md) на пользователя. Укажем в настройках правила категорию трафика с записью в списке адресов:
...
Требуется заблокировать только страницы поддоменов ресурса mail.ru. Создадим [запрещающее правило прокси](../polzovatelskie-pravila-dostupa/zapreschayuschee-pravilo-proksi-2.md) на пользователя. Укажем в настройках правила категорию трафика с записью в списке адресов:
...
Необходимо заблокировать видео в социальной сети ВКонтакте. Создадим [запрещающее правило прокси](../polzovatelskie-pravila-dostupa/zapreschayuschee-pravilo-proksi-2.md) на пользователя. Укажем в настройках правила категорию трафика с регулярным выражением в списке адресов:
...
Требуется заблокировать сайты, содержащие слово казино в домене. Создадим [запрещающее правило прокси](../polzovatelskie-pravila-dostupa/zapreschayuschee-pravilo-proksi-2.md) на пользователя. Укажем в настройках правила категорию трафика с регулярным выражением в списке адресов:
...
Необходимо заблокировать сайты с именем из цифр в домене. Создадим [запрещающее правило прокси](../polzovatelskie-pravila-dostupa/zapreschayuschee-pravilo-proksi-2.md) на пользователя. Укажем в настройках правила категорию трафика с регулярным выражением в списке адресов:
