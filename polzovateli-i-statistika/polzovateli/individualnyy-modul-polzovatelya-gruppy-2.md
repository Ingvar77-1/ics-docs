...
- **«Редактировать»** — редактировать пользователя (форма по аналогии с [добавлением пользователя](dobavit-polzovatelya-gruppu-vruchnuyu.md)).
...
- добавлять [наборы правил](../nabory-pravil/nabory-pravil-obzor.md).
