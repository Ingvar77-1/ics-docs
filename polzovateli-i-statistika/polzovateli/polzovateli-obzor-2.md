...
[Пользователем](../../o-dokumentacii/slovar-terminov-3.md) может быть:
...
При нажатии на пользователя (группу) откроется его [индивидуальный модуль](individualnyy-modul-polzovatelya-gruppy-2.md).
...
- **«Добавить»** — [добавить](dobavit-polzovatelya-gruppu-vruchnuyu.md) пользователя или группу пользователей.
...
- **«Импорт»** — [импортировать](import-polzovateley-2.md) пользователя (группу) из файла, сети или [LDAP](../../o-dokumentacii/slovar-terminov-3.md).

  ![Иллюстрация](../../images/article_124/export.png)

  > ⚠ Внимание! При экспорте пользователей будет утеряна связка IP с MAC-адресом. Также не будет сохранен комментарий, указанный в IP и MAC-адресах. Чтобы перенести пользователей со всеми их настройками, воспользуйтесь созданием [резервной копии](../../obsluzhivanie/rezervnye-kopii-2.md).

- **«Двухфакторная аутентификация»** — становится активной, если активирована [двухфакторная аутентификация](../../obsluzhivanie/nastroyki-interfeysa-2.md). Если вторым фактором активирована «Использовать ТОТР», то при нажатии на «Двухфакторная аутентификация» будут доступны функции: «Показать QR-код ТОТР-токена» и «Обновить ТОТР-токен». Если вторым фактором активирована «Использовать Telegram-бот», то при нажатии на «Двухфакторная аутентификация» будут доступны функции: «Скопировать ссылку» и «Обновить ссылку».

- **«Мастер»** — вызвать [мастер](master-sozdaniya-polzovatelya-gruppy.md) создания пользователя (группы) в ИКС.
