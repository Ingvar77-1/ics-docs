...
При превышении квоты пользователем его доступ к интернет-ресурсам блокируется. При этом если требуется разрешить доступ к [IP-адресу](../../o-dokumentacii/slovar-terminov-3.md), создайте [разрешающее правило](../../set/mezhsetevoy-ekran/razreshayuschee-pravilo-mezhsetevogo-ekrana-2.md) с установленным флагом **«Разрешать трафик, даже если пользователь отключен»**. Если необходимо разрешить доступ к [URL](../../o-dokumentacii/slovar-terminov-3.md), создайте [разрешающее правило прокси](razreshayuschee-pravilo-proksi.md) с установленным флагом **«Разрешать трафик, даже если пользователь отключен»**.
