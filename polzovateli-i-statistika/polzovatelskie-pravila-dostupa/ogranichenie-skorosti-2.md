...
Добавить **ограничение скорости** можно на вкладке **«Правила и ограничения»** в [индивидуальном модуле пользователя (группы)](https://doc.a-real.ru/index.php?article=142), который расположен в меню **Пользователи и статистика &gt; Пользователи**.
...
4. Выберите **способ применения** правила, применяемого к пользователю или группе. Рассмотрим на примере ограничения скорости 500 Кб/сек:
   ...
   - для каждого IP — ограничивает трафик для каждого [IP-адреса](https://doc.a-real.ru/index.php?article=24/#ip-address) (если у пользователя два адреса, каждый будет иметь ограничение в 500 Кб/сек) при назначении как на пользователя, так и на группу.
...
7. Если требуется, укажите, после какого объема данных **включать** ограничение скорости (в Кбайт). Действует только для [HTTP](https://doc.a-real.ru/index.php?article=24/#http)/[HTTPS](https://doc.a-real.ru/index.php?article=24/#https).
8. При необходимости установите флаг **«Ограничивать до ИКС»**. Тогда в правиле будут учитываться и соединения, входящие на ИКС (например, при доступе к [FTP](https://doc.a-real.ru/index.php?article=24/#ftp)-ресурсу или графическому интерфейсу).
...
**Источник:** [Документация ИКС — Ограничение скорости](https://doc.a-real.ru/index.php?article=162)
