...
> ⚠ Внимание! Правило действует, если настроен [контент-фильтр](https://doc.a-real.ru/index.php?article=76). Чтобы блокировать с помощью контент-фильтра зашифрованные [HTTPS](../../o-dokumentacii/slovar-terminov-3.md)-страницы, необходимо [настроить HTTPS-фильтрацию](../../set/proksi/nastroyka-httpsfiltracii-2.md) с подменой сертификата.
