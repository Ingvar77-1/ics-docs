...
В левой части вкладки отображается список всех отчетов: предустановленных системой и созданных пользователем ИКС с [ролью](../roli-2.md) «Администратор». Нажмите на название нужного отчета — он отобразится в правой части вкладки.
...
- <strong>Вид</strong> — позволяет задать один из возможных вариантов отображения:
  - детализация IP — отображает таблицу со статистикой всех соединений, прошедших через ИКС, по [IP-адресам](../../o-dokumentacii/slovar-terminov-3.md);
  - детализация HTTP — отображает таблицу со статистикой по [HTTP](../../o-dokumentacii/slovar-terminov-3.md)/[HTTPS](../../o-dokumentacii/slovar-terminov-3.md)-трафику, полученную от [прокси-сервера](../../o-dokumentacii/slovar-terminov-3.md);
...
- <strong>Интерфейс</strong> — фильтрует сгруппированную статистику по интерфейсу, заведенному в ИКС. В качестве интерфейса возможно указать: туннели, [DMZ](../../o-dokumentacii/slovar-terminov-3.md), [VPN](../../o-dokumentacii/slovar-terminov-3.md), внешние и внутренние интерфейсы.
...
- <strong>Протокол</strong> — фильтрует сгруппированную статистику по одному из протоколов: [IP](../../o-dokumentacii/slovar-terminov-3.md), [ICMP](../../o-dokumentacii/slovar-terminov-3.md), [TCP](../../o-dokumentacii/slovar-terminov-3.md), [UDP](../../o-dokumentacii/slovar-terminov-3.md), [GRE](../../o-dokumentacii/slovar-terminov-3.md), [IPIP](../../o-dokumentacii/slovar-terminov-3.md), [L2TP](../../o-dokumentacii/slovar-terminov-3.md).
...
- <strong>MIME-тип</strong> — фильтрует сгруппированную статистику по одному из предустановленных [MIME-типов](../../o-dokumentacii/slovar-terminov-3.md).
...
- Блок <strong>«Автоматически удалять»</strong> позволяет установить <strong>временные рамки</strong> или <strong>квоту</strong> на хранение данных статистики и детализированной статистики. Данные рамки также можно [настроить](../../obsluzhivanie/sistema-2.md) в модуле «Система».
