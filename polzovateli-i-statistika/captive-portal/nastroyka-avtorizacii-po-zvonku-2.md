...
4. Если внешний входящий вызов, пришедший на SIP-провайдера модуля IP-телефонии ИКС, пришел с указанного в **Шаге 2** номера, то пользователь успешно авторизуется. Вызов при этом сбрасывается (Hangup). В противном случае вызов проходит дальше по [правилам IP-телефонии](../../telefoniya/pravila-telefonii/pravila-telefonii-obzor-2.md) ИКС.
