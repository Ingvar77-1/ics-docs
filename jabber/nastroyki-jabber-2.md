...
При установке флага **«Автоматически создавать разрешающее правило»** в межсетевом экране ИКС будет добавлено [разрешающее правило](https://doc.a-real.ru/index.php?article=206) для доступа к указанному порту на всех сетевых интерфейсах.
...
Поле **«Сертификат SSL»** необходимо для создания защищенного соединения «клиент-сервер». По умолчанию данные передаются в открытом виде. Чтобы избежать этого, выберите в поле заранее сгенерированный [SSL](https://doc.a-real.ru/index.php?article=24#ssl)-сертификат для Jabber-сервера.
...
При установке флага **«Использовать общий ростер»** включается общий [ростер](https://doc.a-real.ru/index.php?article=98).
...
**Источник:** [Документация ИКС — Настройки Jabber](https://doc.a-real.ru/index.php?article=96)
