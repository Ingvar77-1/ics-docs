...
В поле **«E-mail администратора»** можно указать e-mail ответственного за веб-сервер системного администратора на тот случай, если в работе сервера возникнут перебои. Также данное поле используется для получения [Let's Encrypt-сертификата](lets-encrypt.md).
...
Флаг **«Использовать Web Application Firewall»** подключает модуль [Web Application Firewall](../../zaschita/web-application-firewall.md).
...
- [Ссылка на виртуальный хост](ssylka-na-virtualnyy-host.md)
- [Let's Encrypt](lets-encrypt.md)

При создании нового веб-ресурса или виртуального хоста в сервере баз данных MySQL за ним закрепляется [база данных](baza-dannyh.md).

На данной вкладке доступны операции **включения/выключения** веб-ресурса, его **редактирования** и **удаления**, а также просмотра [базы данных](baza-dannyh.md). Для этого просто нажмите на нужный веб-ресурс в списке и выберите действие.
