...
4. Если требуется, введите **описание**. Это краткое описание ресурса, которое будет отображаться в списке [веб-ресурсов](veb-obzor-2.md), а также в [хранилище файлов](https://doc.a-real.ru/index.php?article=80) рядом с соответствующей папкой.
